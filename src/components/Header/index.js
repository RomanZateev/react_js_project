...
export default function Header() {
    ...
    return (
      ...
      <header>
        <a href="/"><img src={HeaderLogo} alt="logo" class="logo"/></a>
        <a class="nav nav1" href="/restaurants">Delivery</a>
        <a href="#"><img  class="dormitory" src={Dorm} alt="logo"/></a>
        <a class="nav nav2" href="/foodsharing">Food sharing</a>  
        <div class="basket-accont">
            <a href="#"><img  class="basket" src={Basket} alt="logo"/></a>
            <a href="/auth"><img class="acount" src={Acount} alt="logo"/></a>
        </div> 
      </header>
      </React.Fragment>
    )
