                ...
                <div class="description">
                    <div class="main-delivery-speed">
                        ...
                        <div class="main-text test">
                            ...
                            <p class="main-text-p" > Наш сервис поддерживает множество кафе и ресторанов, предоставляющих 
                                как традиционную, так и веганскую кухню</p>
                        </div>
                    ...
                    <div class="main-delivery-speed">
                        ...
                        <p class="main-text-p">Доставим ваш заказ в сжатые сроки прямо к комнате</p>
                        </div>
                    ...
                    <div  class="main-food-sharing">
                        ...
                        <p class="main-text-p" >Вы всегда можете купить еду у соседа или предложить свою</p>
                        </div>
                    </div>
                </div>
